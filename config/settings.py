...
# The app runs behind Nginx on EC2, so respect forwarded scheme/host when
# building absolute URLs for widgets, API links, and redirects.
...
EXTERNAL_TICKETING_PULL_SYNC_MAX_AGE_SECONDS = int(os.getenv("EXTERNAL_TICKETING_PULL_SYNC_MAX_AGE_SECONDS", "60"))
SPECIAL_INSTRUCTION_BASE_URL = os.getenv("SPECIAL_INSTRUCTION_BASE_URL", "https://stage.red-flag-alerts.co.in").strip()
SPECIAL_INSTRUCTION_PM_API_TOKEN = os.getenv("SPECIAL_INSTRUCTION_PM_API_TOKEN", "").strip()
SPECIAL_INSTRUCTION_TIMEOUT = float(os.getenv("SPECIAL_INSTRUCTION_TIMEOUT", "10"))
SPECIAL_INSTRUCTION_REVIEW_DEPARTMENT_CODE = os.getenv("SPECIAL_INSTRUCTION_REVIEW_DEPARTMENT_CODE", "CAMP-OPS").strip()
